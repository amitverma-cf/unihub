                ...
                <div className="container py-24 lg:py-32">
                    <div className="text-center">
                        ...
                        <p className="mt-3 text-xl text-muted-foreground">
                            Stay in the know with insights from peers, professors and industry experts.
                        </p>
                        <div className="mt-7 z-10 sm:mt-12 mx-auto max-w-xl relative flex justify-center gap-6">
                            {/* Form */}
                            <Link href={"protected/create-post"}>
                                <Button className="p-8">Create Post</Button>
                            </Link>
                            <form>
                                <div className="relative flex space-x-3 p-3 border bg-background rounded-lg shadow-lg">
